...
def get_next_wednesday():
    today = datetime.now()
    # Monday is 0, Tuesday is 1, Wednesday is 2
    days_until_wednesday = (2 - today.weekday()) % 7
    # If it runs exactly on Wednesday midnight, target the NEXT Wednesday (7 days away)
...
def send_email(subject, body):
    if not SMTP_USER or not SMTP_PASS:
        print("⚠️ Email credentials not found. Skipping email notification.")
        return
...
def run():
    with sync_playwright() as p:
        ...
        # 41 represents 8:00 PM in the system
        ...
        page.select_option("#Reservation_Type", "P")  
        ...
        failure_keywords = ["already reserved", "conflict", "unavailable", "error", "cannot reserve", "exceeds limit"]
        ...
        if has_error:
            ...
            summary_text = (
                ...
                f"* **Target Date:** {target_date} (Wednesday)\n"
            ...
            send_email(
                ...
                body=f"Hello,\n\nGreat news! The automated script successfully booked the Pickleball court for Wednesday, {target_date} at 8:00 PM (Court 1) for 1.5 hours.\n\nEnjoy your game!"
            )
